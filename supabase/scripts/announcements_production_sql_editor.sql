-- =============================================================================
-- NAGISA Link: announcements（本番 Supabase SQL Editor 用・冪等）
-- 事前: public.set_updated_at() と public.is_admin_user() が既存マイグレーションで存在すること。
-- 未作成の場合は先に本体のマイグレーションを適用してください。
-- =============================================================================
...
-- API ロール（Postgres の表現は authenticated）
...
-- RLS: 既存ポリシー名を drop してから作り直し（重複防止）
